...
capture, constructor-arity, diagnostics parity, and macOS i18n-link
regressions; release fixtures and known-failure inventories match current
behavior again; and lint, warning, documentation, audit, and public benchmark
