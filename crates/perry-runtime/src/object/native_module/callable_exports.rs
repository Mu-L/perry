...
pub(crate) fn bound_native_callable_export_value(module_name: &str, property_name: &str) -> f64 {
    ...
    crate::closure::js_closure_set_capture_f64(closure.get_raw_mut_ptr(), 0, ns.get_nanbox_f64());
    crate::closure::js_closure_set_capture_ptr(
        closure.get_raw_mut_ptr(),
        1,
        method_bytes.as_ptr() as i64,
    );
    crate::closure::js_closure_set_capture_ptr(
        closure.get_raw_mut_ptr(),
        2,
    ...
    set_bound_native_closure_name(closure.get_raw_mut_ptr(), exposed_name);
