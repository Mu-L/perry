...
/// the bootstrap identity before removing Node's internal `NODE_UNIQUE_ID`
/// variable, so extension crates must use this ABI rather than re-reading the
/// environment.
